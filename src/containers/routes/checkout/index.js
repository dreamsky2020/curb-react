...
class CheckOut extends React.Component {
    ...
    componentDidMount(){
        ...
        this.setState({shoes: shoeses[0], price: shoeses[0].lowestBid})
    }
    ...
    paypalPayment = () => {
        ...
        setTimeout(()=>{ 
            ...
            this.setState({ loading: false, paymentMethod: 'paypal'}) 
                                ...
                                <Form>
                                    ...
                                    </div>
                                    {
                                        ...
                                        <div className="d-flex mt-5 flex-column flex-md-row">
                                            <Button type="primary" icon={<IdcardOutlined/>} className="w-100 mr-0 mr-md-3 mb-2 mb-md-0" size="large" style={{minHeight: '50px'}} onClick={this.cardComplete}>CARD COMPLETE</Button>
                                            <Button loading={this.state.loading} className="paypal-btn" size="large"  style={{minHeight: '50px'}} onClick={this.paypalPayment}>PAYPAL PAYMENT</Button>
                                        </div>
                                    }
                                    {
                                        this.state.paymentMethod &&
                                        <div className="d-flex mt-5 flex-column flex-md-row">
                                            <Button size="large" className="w-100 mr-0 mr-md-3 mb-2 mb-md-0"  style={{minHeight: '50px'}} onClick={this.backPaymentMethod}>BACK</Button>
                                            <Button loading={this.state.loading} type="primary" className="w-100" size="large" style={{minHeight: '50px'}} onClick={this.completeOrder}>COMPLETE ORDER</Button>
                                        </div>
                                    }
                                </Form>
                            </div>
